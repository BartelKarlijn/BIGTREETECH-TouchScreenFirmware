...
#define _LANGUAGE_RU_H_
    ...
    #define RU_RESTORE                "Restore"
    #define RU_RESET                  "Сброс"
    #define RU_DEFAULT                "Default"
    #define RU_NEXT                   "Next"
    #define RU_DISTANCE               "Distance"
    #define RU_INVALID_VALUE          "No valid value/s provided!"
    #define RU_TIMEOUT_REACHED        "Timeout reached!"
    #define RU_PROCESS_RUNNING        "Process running! Wait completion"
    #define RU_PROCESS_COMPLETED      "Process completed!"
    #define RU_PROCESS_ABORTED        "Process aborted!"
    ...
    #define RU_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    ...
    #define RU_ACK_POPUP_TYPE         "ACK popup type"
    #define RU_ACK_BUZZER             "ACK buzzer"
    #define RU_LEVELING_EDGE_DISTANCE "Bed edge distance"
    #define RU_XY_UNLOCK              "Разблокировать XY"
    #define RU_TUNING                 "Tuning"
    #define RU_PID                    "PID"
    #define RU_PID_TITLE              "PID autotune"
    #define RU_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
    #define RU_PID_START_INFO_2       "PID autotune in progress!"
