...
#define _LANGUAGE_HU_H_
    ...
    #define HU_ABL_SLOT_EEPROM        "Emlékszel a következő\nújraindítás helyére? \n \n(EEPROM Mentése)"
    ...
    #define HU_RESTORE                "Restore"
    #define HU_RESET                  "Alap"
    #define HU_DEFAULT                "Default"
    #define HU_NEXT                   "Next"
    #define HU_DISTANCE               "Distance"
    #define HU_INVALID_VALUE          "No valid value/s provided!"
    #define HU_TIMEOUT_REACHED        "Timeout reached!"
    #define HU_PROCESS_RUNNING        "Process running! Wait completion"
    #define HU_PROCESS_COMPLETED      "Process completed!"
    #define HU_PROCESS_ABORTED        "Process aborted!"
    ...
    #define HU_PLR_EN                 "Energiavesztés visszanyerése"
    ...
    #define HU_EEPROM_RESTORE_INFO    "Betölti a beállításokat az \nEEPROM-ból?"
    #define HU_EEPROM_RESET_INFO      "Visszaállítod az EEPROM-ot a gyári beállításra?"
    ...
    #define HU_ACK_POPUP_TYPE         "ACK egyéb típus"
    #define HU_ACK_BUZZER             "ACK jelző"
    #define HU_LEVELING_EDGE_DISTANCE "Ágy szélének távolsága"
    #define HU_XY_UNLOCK              "Kinyit XY"
    #define HU_TUNING                 "Tuning"
    #define HU_PID                    "PID"
    #define HU_PID_TITLE              "PID önhangolás"
    #define HU_PID_START_INFO         "A PID önhangolása elindul. Percekig is eltarthat. Folytatod?"
    #define HU_PID_START_INFO_2       "PID önhangolás folyik!"
