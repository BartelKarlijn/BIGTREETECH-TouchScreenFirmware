...
#define _LANGUAGE_CN_H_
    ...
    #define CN_UP                     "Up"
    #define CN_SAVE                   "保存参数"
    #define CN_RESTORE                "Restore"
    #define CN_RESET                  "重置"
    #define CN_DEFAULT                "Default"
    #define CN_NEXT                   "Next"
    #define CN_DISTANCE               "Distance"
    #define CN_INVALID_VALUE          "No valid value/s provided!"
    #define CN_TIMEOUT_REACHED        "Timeout reached!"
    #define CN_PROCESS_RUNNING        "Process running! Wait completion"
    #define CN_PROCESS_COMPLETED      "Process completed!"
    #define CN_PROCESS_ABORTED        "Process aborted!"
    ...
    #define CN_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    ...
    #define CN_ACK_POPUP_TYPE         "ACK popup type"
    #define CN_ACK_BUZZER             "ACK buzzer"
    #define CN_LEVELING_EDGE_DISTANCE "Bed edge distance"
    #define CN_XY_UNLOCK              "解锁XY"
    #define CN_TUNING                 "Tuning"
    #define CN_PID                    "PID"
    #define CN_PID_TITLE              "PID autotune"
    #define CN_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
    #define CN_PID_START_INFO_2       "PID autotune in progress!"
