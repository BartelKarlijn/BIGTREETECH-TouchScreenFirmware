...
#define _LANGUAGE_DU_H_
    ...
    #define DU_RESTORE                "Restore"
    #define DU_RESET                  "Reset"
    #define DU_DEFAULT                "Default"
    #define DU_NEXT                   "Next"
    #define DU_DISTANCE               "Distance"
    #define DU_INVALID_VALUE          "No valid value/s provided!"
    #define DU_TIMEOUT_REACHED        "Timeout reached!"
    #define DU_PROCESS_RUNNING        "Process running! Wait completion"
    #define DU_PROCESS_COMPLETED      "Process completed!"
    #define DU_PROCESS_ABORTED        "Process aborted!"
    ...
    #define DU_KNOB_LED_IDLE          "Rotary Knob led idle"
    ...
    #define DU_EEPROM_RESET_INFO      "Reset EEPROM to stock printer settings?"
    ...
    #define DU_PID_START_INFO         "PID autotune will be started. It can take minutes. Continue?"
    #define DU_PID_START_INFO_2       "PID autotune in progress!"
